...
public class PublishPlatformDefaultsIbmMqApprovalTest : AspireApplicationPublishingTestBase
{
    protected override void BuildApplication(IDistributedApplicationBuilder builder)
    {
        ...
        var platform = builder
            ...
            .WithTransportIbmMq(builder.AddDummyConnectionString("transport-connection"));
